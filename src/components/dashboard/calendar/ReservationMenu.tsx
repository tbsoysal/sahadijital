...
export function ReservationMenu({
  ...
  return (
    selectedSlot && (
      <div
        className={`fixed right-0 bottom-0 left-0 z-10 h-[510px] transform overflow-scroll bg-white transition-transform duration-500 ease-in-out ${isOpen ? "translate-y-0" : "translate-y-full"} `}
      >
        {/* Cancel & Save Buttons */}
        ...
        <div className="mb-5 border-b border-[#E9EAEB] px-5 py-4">
          <p className="text-primary font-medium">Ödeme Bilgileri</p>
          <div className="flex items-center justify-between gap-5">
            ...
            <div className="flex items-center gap-1">
              ...
              <input
                placeholder="2000"
                className="max-w-[100px] border-0 p-0! font-medium text-black outline-0"
              />
            </div>
            <div>
